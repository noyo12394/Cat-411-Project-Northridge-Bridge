  ...
  return (
    <div className="rounded-[32px] border border-slate-200/70 bg-white/95 p-5 shadow-[0_28px_70px_rgba(15,23,42,0.08)]">
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="text-sm text-slate-500">Showing {rows.length} of {normalizedBridges.length.toLocaleString()}</div>
      </div>
            ...
            {rows.map((bridge) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-slate-600">{formatFixed(bridge.svi)}</td>
