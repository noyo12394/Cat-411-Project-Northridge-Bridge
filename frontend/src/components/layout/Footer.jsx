export default function Footer() {
  return (
    <footer className="mx-auto mt-20 max-w-[1440px] px-4 pb-12 sm:px-6 lg:px-8">
      <div className="rounded-[32px] border border-slate-700/40 bg-[linear-gradient(180deg,#0f1929_0%,#0b1421_100%)] px-6 py-8 text-slate-200 shadow-[0_24px_80px_rgba(15,23,42,0.28)] sm:px-8 lg:px-10">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-3">
            <p className="font-mono text-[11px] uppercase tracking-[0.32em] text-blue-100">Research demo footer</p>
